...
public class ItemCategory implements Serializable{
   ...
   /** @pdRoleInfo migr=no name=ActionEvent assc=onDiscount coll=Set impl=HashSet mult=0..* side=A */
   private Set<ActionEvent> actions;
   
   /** @pdRoleInfo migr=no name=ItemCategory assc=subcategories coll=Set impl=HashSet mult=0..* */
   private Set<ItemCategory> subCategories;
   /** @pdRoleInfo migr=no name=Item assc=itemCategory coll=Set impl=HashSet mult=0..* */
   ...
   public void setParentCategory(ItemCategory newItemCategory) {
      if (this.parentCategory == null || !this.parentCategory.equals(newItemCategory))
      {
